          ...
          >
            ...
            <div className="mt-10 flex flex-wrap gap-4 items-center">
               <a 
                 ...
                 className="w-12 h-12 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:border-slate-600 hover:bg-slate-100 dark:bg-slate-800 rounded-full flex items-center justify-center text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:text-white transition-all"
                 aria-label="Email"
               >
                 <Mail size={20} />
               </a>
