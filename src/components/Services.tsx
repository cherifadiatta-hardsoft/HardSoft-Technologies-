      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, index) => (
            <motion.div
              ...
              className="bg-slate-900 border border-slate-800 rounded-2xl p-8 hover:-translate-y-1 hover:border-indigo-500/50 hover:bg-slate-800/50 transition-all group"
            >
              <div className="w-16 h-16 rounded-xl bg-slate-950 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                {service.icon}
              </div>
        ...
        <div className="mt-16 text-center">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-[#25D366] hover:bg-[#128C7E] text-white font-semibold rounded-full transition-colors shadow-lg shadow-[#25D366]/20 max-w-full"
            >
