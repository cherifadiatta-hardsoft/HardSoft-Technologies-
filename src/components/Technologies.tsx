      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-slate-950 p-8 rounded-3xl border border-slate-800"
          >
            ...
            <div className="flex flex-wrap gap-3">
              {frontendFrameworks.map((fw) => (
                <span key={fw} className="px-4 py-2 bg-slate-900 border border-slate-700 text-slate-300 rounded-full text-sm font-medium hover:border-indigo-500 hover:text-indigo-400 transition-colors cursor-default">
                  {fw}
                </span>
              ))}
            </div>
          ...
          >
            ...
            <div className="flex flex-wrap gap-3">
              {backendFrameworks.map((fw) => (
                <span key={fw} className="px-4 py-2 bg-slate-900 border border-slate-700 text-slate-300 rounded-full text-sm font-medium hover:border-emerald-500 hover:text-emerald-400 transition-colors cursor-default">
                  {fw}
                </span>
              ))}
            </div>
