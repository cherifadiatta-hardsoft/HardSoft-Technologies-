    ...
    <section id="pos" className="py-24 bg-slate-900">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-slate-700 bg-slate-950 aspect-[4/3] flex items-center justify-center">
             ...
             <div className="w-full h-full p-6 flex flex-col gap-4 opacity-80">
                ...
                <div className="flex-1 grid grid-cols-3 gap-4">
                    <div className="col-span-2 flex flex-col gap-4">
                        <div className="h-1/2 bg-slate-800/50 border border-slate-700/50 rounded-xl p-4 flex flex-col gap-2 justify-end">
                         ...
                         <div className="h-1/2 flex gap-4">
                            <div className="flex-1 bg-slate-800/50 border border-slate-700/50 rounded-xl"></div>
                            <div className="flex-1 bg-slate-800/50 border border-slate-700/50 rounded-xl"></div>
                         </div>
                    </div>
                    <div className="col-span-1 bg-slate-800/50 border border-slate-700/50 rounded-xl p-4 flex flex-col gap-3">
                        <div className="h-4 w-1/2 bg-slate-700 rounded mb-2"></div>
                        {[1, 2, 3, 4, 5].map((i) => (
                             <div key={i} className="h-12 bg-slate-700/30 rounded flex items-center px-3 justify-between">
